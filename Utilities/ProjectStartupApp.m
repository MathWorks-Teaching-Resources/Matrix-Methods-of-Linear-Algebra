...
%}
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            ...
            movegui(app.StartUpAppUIFigure,"center")
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.WelcomeTitle.Text = 'Matrix Methods of Linear Algebra';
            ...
            app.ReviewTitle.Text = 'Welcome to Matrix Methods of Linear Algebra';
